...
```
ba-project/
├── generate_data.py    # creates a synthetic but realistic retail dataset
├── db_setup.py         # loads CSVs into a normalized SQLite database
...
python db_setup.py           # builds data/retail.db
